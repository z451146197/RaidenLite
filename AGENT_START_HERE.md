...
4. 按自己的工作线读取：
   - 1 线：`docs/HANDOFF_LINE1_GAMEPLAY.md`
   - 2 线：`docs/HANDOFF_LINE2_ENVIRONMENT.md`
   - 3 线：`docs/HANDOFF_LINE3_ORCHESTRATION.md`
...
本文件只提供入口；详细状态与任务以 `docs/HANDOFF_INDEX.md` 和各线 handoff 为准。
